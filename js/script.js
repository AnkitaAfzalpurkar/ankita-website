...
( () => {
    ...
    function e(e) {
        ...
        "dropdown" === d && (document.getElementById("ast-mobile-popup").classList.remove("active", "show"),
        g("updateHeader")),
        "off-canvas" === d && e.forEach(function(e) {
        ...
        if (null == m || "dropdown" !== m.dataset.type || "updateHeader" === e) {
            (void 0 !== e && "updateHeader" !== e ? e.closest(".ast-mobile-popup-inner") : document.querySelector("#ast-mobile-popup")).querySelectorAll(".menu-item-has-children").forEach(e => {
                ...
                Array.from(e.querySelectorAll(".sub-menu")).forEach(e => {
                    e.hasAttribute("data-initial-display") || e.setAttribute("data-initial-display", window.getComputedStyle(e).display),
                    "block" === e.getAttribute("data-initial-display") ? e.style.display = "block" : e.style.display = "none"
                }
                )
            }
            );
    ...
    function t(e) {
        ...
        if ("off-canvas" === e) {
            ...
            for (var s = 0; s < t.length; s++)
                t[s].removeEventListener("click", astraNavMenuToggle, !1),
                t[s].removeEventListener("click", popupTriggerClick),
                t[s].addEventListener("click", popupTriggerClick, !1),
                t[s].trigger_type = "mobile";
            for (s = 0; s < a.length; s++)
                a[s].removeEventListener("click", astraNavMenuToggle, !1),
                a[s].removeEventListener("click", popupTriggerClick),
                a[s].addEventListener("click", popupTriggerClick, !1),
                a[s].trigger_type = "desktop";
            ...
            for (s = 0; s < t.length; s++)
                t[s].removeEventListener("click", popupTriggerClick, !1),
                t[s].removeEventListener("click", astraNavMenuToggle),
                t[s].addEventListener("click", astraNavMenuToggle, !1),
                t[s].trigger_type = "mobile";
            for (s = 0; s < a.length; s++)
                a[s].removeEventListener("click", popupTriggerClick, !1),
                a[s].removeEventListener("click", astraNavMenuToggle),
    ...
    window.addEventListener("resize", function() {
        ...
        (null !== navigator.userAgent.match(/Android/i) && "Android" === navigator.userAgent.match(/Android/i)[0] ? window.visualViewport.width : window.innerWidth) !== o && (t && null === n && t.click(),
        document.body.classList.remove("ast-main-header-nav-open", "ast-popup-nav-open"),
        e) && null == n && e.click(),
        v(),
        AstraToggleSetup())
        ...
        null !== (e = u.classList.contains("ast-header-break-point") ? document.getElementById("ast-mobile-header") : document.getElementById("ast-desktop-header"))) {
            ...
            if (t && e) {
                ...
                if (a && !a.classList.contains("astra-search-icon")) {
                    ...
                    if (n) {
                        if (n.className.includes("nav-menu") || (n.className += " nav-menu"),
                        document.addEventListener("DOMContentLoaded", function() {
                            var e;
                            "off-canvas" === d && (e = document.getElementById("menu-toggle-close")) && (e.onclick = function() {
                                var e = t.className.includes("toggled");
                                t.className = e ? t.className.replace(" toggled", "") : t.className + " toggled",
                        ...
                        !astra.is_header_footer_builder_active) {
                            for (var o = n.getElementsByTagName("a"), s = n.getElementsByTagName("ul"), r = 0, l = s.length; r < l; r++)
                                s[r].parentNode.setAttribute("aria-haspopup", "true");
                            for (r = 0,
                            l = o.length; r < l; r++)
                                o[r].addEventListener("focus", E, !0),
                                o[r].addEventListener("blur", E, !0),
                                o[r].addEventListener("click", b, !0)
                        }
                        astra.is_header_footer_builder_active && ( () => {
                            ...
                            e && e.forEach(e => {
                                e.addEventListener("keydown", function(e) {
                                    e.target.closest("li").classList.contains("ast-menu-hover") || "Enter" !== e.key || L(a, t, n, o)
                                }, !1)
                            }
                            )
                        }
    ...
    for (var a, n, s, l, v = function() {
        ...
        if (a.length) {
            ...
            t && (e = document.querySelector("#ast-hb-login-close"),
    ...
    AstraToggleSetup = function() {
        if ("undefined" != typeof astraAddon && "function" == typeof astraToggleSetupPro)
            ...
            (n = !(0 < (e = (a = document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle")).length))) ? 1 : e)) || n)
                for (var o = 0; o < e; o++)
                    if (n || (a[o].setAttribute("data-index", o),
                    i[o]) || (i[o] = a[o],
    ...
    /trident/i.test(n[1]) ? a = /\brv[ :]+(\d+)/g.exec(S) || [] : "Chrome" === n[1] && null != (a = S.match(/\bOPR|Edge\/(\d+)/)) || (n = n[2] ? [n[1], n[2]] : [navigator.appName, navigator.appVersion, "-?"],
    null != (a = S.match(/version\/(\d+)/i)) && n.splice(1, 1, a[1]),
    "Safari" === n[0] && n[1] < 11 && document.body.classList.add("ast-safari-browser-less-than-11")),
    ...
    astra.is_scroll_to_id) {
        ...
        var k = e => {
            ...
            a = e.target.closest("a").hash) && (a = document.querySelector(a)) && (a = o(a) - t) && astraSmoothScroll(e, a)
        }
        ;
        let t = [];
        ...
        if (S)
            for (let e of S)
                e.href.split("#")[0] !== location.href.split("#")[0] ? t.push({
                    hash: e.hash,
                    url: e.href.split("#")[0]
    ...
    astra.is_scroll_to_top && (s = document.querySelector("#page header"),
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll(".menu-item-has-children > a").forEach(t => {
        t.addEventListener("keydown", function(e) {
            "Enter" === e.key && (e = t.nextElementSibling) && e.classList.contains("sub-menu") && (e.classList.toggle("ast-visible"),
